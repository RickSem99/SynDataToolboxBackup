...
#include "Components/ActionManagers/DiscreteActionManagerSDT.h"
...
const int8_t ADiscreteActionManagerSDT::TurnRight()
{
	...
	SetActorLocationAndRotation(GetActorLocation(),CurrentActorRotation,true,ActorHit);
	if (ActorHit->bBlockingHit)
	{
		return 1;
	}
...
FHitResult* ADiscreteActionManagerSDT::GetHitHandler()
{
	return ActorHit;
}
