...
#include "../PhysicsControlManagers/UniformPhysicsManagerSDT.h"
#include "../PhysicsControlManagers/PIDManagerSDT.h"
#include "../PhysicsControlManagers/ProportionalPIDManagerSDT.h"
#include "ControlledActionManagerSDT.generated.h"

UCLASS()
class SYNDATATOOLBOX_API AControlledActionManagerSDT : public APawn, public IActionManagerSDT
{
	GENERATED_BODY()

public:
	// Sets default values for this pawn's properties
	AControlledActionManagerSDT();
...
protected:
	...
	//compute "physics"
	const int8_t PIDComputation(float DeltaTime);
	...
	UPROPERTY(EditAnywhere, Category = "ActionManagerProperties | Physics")
		float TargetLinearVelocity = 0.0f;
	//rad/s. Sign indicates direction
	UPROPERTY(EditAnywhere, Category = "ActionManagerProperties | Physics")
